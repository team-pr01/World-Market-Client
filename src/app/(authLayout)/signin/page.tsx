...
import { AlertCircle, ArrowRight, CheckCircle, Eye, EyeOff, Lock, User, User2 } from "lucide-react";
...
const SignIn = () => {
     ...
     const onSubmit = async (data: any) => {
          try {
               ...
               toast.error(error?.data?.message || "An error occurred while signing in.");
          }
     };
     return (
