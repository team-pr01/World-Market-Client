...
import { ArrowDown, ArrowUp, ChevronDown, Minus, Plus, Search, Star, X } from "lucide-react";
        ...
        <aside className="w-[240px] border-l border-gray-800 bg-[#1A1D27] overflow-y-auto">
            <div className="p-3">
              <div className="mb-4">
                ...
                >
                  <span className="mr-1 min-w-[24px] text-center">Selected Market Icon</span>
                  <span className="font-medium truncate max-w-[100px]">Selected Market Name</span>
                  <span className="ml-1 text-yellow-500">Selected Market %</span>
                  <ChevronDown
                    size={16}
                      ...
                      {markets.length > 0 ? (
                        markets.map((market) => (
                          ...
                          >
                            ...
                            >
                              <span className="mr-2 text-lg min-w-[24px] text-center">{market.logo}</span>
              ...
              <div className="rounded border border-gray-800 mt-4">
                ...
                <div className="p-3 max-h-[250px] overflow-y-auto space-y-2">
                  {tradeList.length > 0 ? (
                    tradeList.map((trade) => <TradeListItem key={trade.id} trade={trade} />)
                  ) : (
