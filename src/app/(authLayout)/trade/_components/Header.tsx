  ...
  return (
       <header className="flex h-14 items-center justify-between border-b border-gray-800 px-4">
            <div className="flex items-center">
                 ...
                 <span className="text-gray-400 text-sm hidden xl:block">WEB TRADING PLATFORM</span>
            </div>
            <div className="hidden xl:flex items-center bg-green-500/20 rounded-full px-4 py-1.5">
