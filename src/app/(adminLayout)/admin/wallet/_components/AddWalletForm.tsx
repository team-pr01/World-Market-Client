              ...
              {selectedType === "auto" && (
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    {...register("api_key.public_key")}
                    className="bg-gray-700 border-gray-600 text-white"
                  />
                  <Input
                    placeholder="Secret Key"
                    {...register("api_key.secret_key")}
                    className="bg-gray-700 border-gray-600 text-white"
                  />
                  <Input
                    placeholder="Webhook Secret"
                    {...register("api_key.webhook_secret")}
                    className="bg-gray-700 border-gray-600 text-white"
                  />
                  <Input
                    placeholder="Merchant ID"
                    {...register("api_key.merchant_id")}
                    className="bg-gray-700 border-gray-600 text-white"
                  />
                  <Input
                    placeholder="API URL"
                    {...register("api_key.api_url")}
                    className="bg-gray-700 border-gray-600 text-white"
                  />
                </div>
              )}
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      {...register("wallet_info.crypto.wallet_address")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                    <Input
                      placeholder="Network"
                      {...register("wallet_info.crypto.network")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                    <Input
                      placeholder="QR Code URL"
                      {...register("wallet_info.crypto.qr_code")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                    <Textarea
                      placeholder="Instructions"
                      {...register("wallet_info.crypto.instructions")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      {...register("wallet_info.mobile.account_type")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                    <Input
                      placeholder="Account Name"
                      {...register("wallet_info.mobile.account_name")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                    <Input
                      placeholder="Account Number"
                      {...register("wallet_info.mobile.account_number")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      {...register("wallet_info.bank.bank_name")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                    <Input
                      placeholder="Bank Code"
                      {...register("wallet_info.bank.bank_code")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                    <Input
                      placeholder="Bank Address"
                      {...register("wallet_info.bank.bank_address")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                    <Input
                      placeholder="SWIFT Code"
                      {...register("wallet_info.bank.bank_swift")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                    <Input
                      placeholder="Bank Account"
                      {...register("wallet_info.bank.bank_account")}
                      className="bg-gray-700 border-gray-600 text-white"
                    />
                  </div>
                </div>
