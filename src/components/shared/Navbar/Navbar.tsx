          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              ...
              <Link href="/signup">
                <Button
                  size="sm"
                  className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-xs sm:text-sm lg:text-base cursor-pointer px-2 sm:px-3 lg:px-6 py-1 sm:py-2"
                >
                  Get Started
                </Button>
              </Link>
